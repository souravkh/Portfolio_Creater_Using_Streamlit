...
if os.path.exists(static_resume_path):
    ...
    resume_tag = f'''<a href="{resume_url}" download="{resume_file_name}" target="_blank" class="portfolio-btn" style="text-decoration: none;">
        📄 Download Resume
    </a>'''
else:
    resume_tag = "<span style='color:#71717A; font-size:0.85rem; display:inline-flex; align-items:center; font-weight:500;'>Resume not available</span>"
...
st.markdown("""
    ...
    <style>
        ...
        /* ── Modern Minimalist Buttons with Electric Orange Hover ── */
        .portfolio-btn {
            display: inline-flex;
            align-items: center;
            gap: 8px;
        ...
        .portfolio-btn:hover {
            ...
            box-shadow: 0 4px 12px rgba(255, 95, 31, 0.12);
        }
...
with col2:
    ...
    ">
        <!-- LinkedIn -->
        <a href="{data['profile']['contact']['linkedin']['url']}" target="_blank" class="portfolio-btn" style="text-decoration: none;">
            🔗 LinkedIn
        </a>

        <!-- GitHub -->
        <a href="{data['profile']['contact']['github']['url']}" target="_blank" class="portfolio-btn" style="text-decoration: none;">
        ...
        <!-- Email -->
        <a href="{data['profile']['contact']['mailto']}" class="portfolio-btn" style="text-decoration: none;">
            ✉️ Email Me
        </a>
